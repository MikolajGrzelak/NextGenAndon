...
urlpatterns = [
    ...
    path("daily-panel/<str:workplace>/", views.daily_panel, name="daily_panel"),
    ...
    path("set-workplace/<str:workplace>/", views.set_workplace, name="set_workplace"),
    path("reset-workplace/", views.reset_workplace, name="reset_workplace"),
